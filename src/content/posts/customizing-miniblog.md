---
title: "Customizing z-index.me"
description: "How to customize the z-index.me blog theme."
date: "Nov 26 2024"
---
...
description: "How to customize the z-index.me blog theme."
date: "Nov 26 2024"
image: "/static/blog-placeholder.webp"
---
```

> Note that the `image` frontmatter property is optional, and will by default use `/static/blog-placeholder.webp`. You may update this by replacing the `/static/blog-placeholder.webp` file in the `public/static/` directory with a file of your choice with the same name.
...
To update the site-wide, default OpenGraph image, replace the `/static/blog-placeholder.webp` file in the `public/static/` directory with a file of your choice with the same name.
...
z-index.me uses [Tailwind CSS](https://tailwindcss.com/) for its styling, and therefore uses Tailwind's native color variables throughout the site. By default, z-index.me uses `neutral` for the majority of its colors, with the exception of links that use `blue` and codeblocks that utilize syntax highlighting.
